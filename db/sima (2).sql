...
--
-- Dumping data for table `arsipgambar`
--

INSERT INTO `arsipgambar` (`id_gambar`, `tanggal`, `keterangan`, `image`) VALUES
(0, '2023-05-14', 'xyz', 'centang.png');
...
--
-- Dumping data for table `arsipnota`
--

INSERT INTO `arsipnota` (`id_nota`, `tanggal`, `nama_vendor`, `foto_nota`) VALUES
(0, '2023-05-14', 'Ervin Collection', 'centang1.png');
...
INSERT INTO `jabatan` (`id_jabatan`, `nama_divisi`, `nama_ketua`, `ttd`) VALUES
(1, 'Bagian Aset dan Kerumahtanggaan', 'Bugi Nugroho, S.Kom', 'Screenshot_9.png'),
(2, 'Unit Pengadaan Barang', 'Bagus Adhi Kusuma, M.Kom', 'centang.png');
...
INSERT INTO `pengajuan` (`id`, `barang_id`, `user_id`, `harga`, `jumlah`, `satuan`, `total`, `minggu`, `divisi`, `realisasi`, `waktu_pengajuan`, `waktu_validasi`, `status`, `status_ajuan`, `validasi`, `keterangan`, `deskripsi`) VALUES
(50, 21, 2, '2000', '2', 'Buah', '4000', 2, 'bak', '2', '2023-03-26', '2023-03-27', 'disetujui', NULL, 'diterima', NULL, NULL),
(51, 33, 2, '9000', '2', 'Buah', '18000', 3, 'bak', '2', '2023-03-27', '2023-03-30', 'disetujui', NULL, 'diterima', NULL, NULL),
(52, 21, 2, '3000', '1', 'Buah', '3000', 4, 'bak', '1', '2023-03-27', '2023-03-30', 'disetujui', NULL, 'diterima', NULL, NULL),
(53, 30, 1, '4600', '4', 'Buah', '18400', 2, 'admin', '3', '2023-03-27', '2023-03-30', 'disetujui', NULL, 'diterima', NULL, NULL),
(54, 9, 1, '3000', '2', 'Buah', '6000', 1, 'admin', NULL, '2023-03-27', NULL, 'ditolak', NULL, 'diterima', NULL, NULL),
(56, 21, 2, '2000', '1', 'Buah', '2000', 3, 'bak', '1', '2023-03-27', '2023-03-30', 'disetujui', NULL, 'diterima', NULL, NULL),
(57, 34, 2, '200', '1', 'Buah', '200', 2, 'bak', NULL, '2023-03-27', NULL, 'ditolak', NULL, 'belum diterima', NULL, NULL),
(59, 32, 1, '3000', '2', 'Buah', '6000', 1, 'admin', NULL, '2023-03-27', NULL, 'ditolak', NULL, 'belum diterima', NULL, NULL),
(60, 32, 1, '2000', '2', 'Buah', '4000', 3, 'admin', '2', '2023-03-27', '2023-03-31', 'disetujui', NULL, 'diterima', NULL, NULL),
(61, 33, 1, '3000', '4', 'Buah', '12000', 4, 'admin', NULL, '2023-03-27', NULL, 'ditolak', NULL, 'belum diterima', NULL, NULL),
(62, 35, 2, '1000', '2', 'Buah', '2000', 1, 'bak', '2', '2023-03-28', '2023-03-28', 'disetujui', NULL, 'diterima', NULL, NULL),
(63, 21, 2, '3000', '1', 'Buah', '3000', 1, 'bak', '1', '2023-03-30', '2023-03-30', 'disetujui', NULL, 'diterima', NULL, NULL),
(64, 32, 2, '4000', '2', 'Buah', '8000', 1, 'bak', '2', '2023-03-30', '2023-03-30', 'disetujui', NULL, 'diterima', NULL, NULL),
(66, 33, 2, '3000', '2', 'Buah', '6000', 1, 'bak', '2', '2023-03-30', '2023-03-30', 'disetujui', NULL, 'diterima', NULL, NULL),
(69, 5, 2, '2000', '2', 'Pcs', '4000', 1, 'bak', '2', '2023-04-02', '2023-04-02', 'disetujui', NULL, 'diterima', NULL, NULL),
(70, 21, 2, '200000', '1', 'Buah', '200000', 1, 'bak', '1', '2023-04-02', '2023-04-02', 'disetujui', NULL, 'diterima', NULL, NULL),
(71, 34, 2, '50000', '2', 'Rim', '100000', 1, 'bak', '2', '2023-04-02', '2023-04-02', 'disetujui', NULL, 'diterima', NULL, NULL),
(76, 32, 2, '350000', '1', 'Buah', '350000', 1, 'bak', '1', '2023-04-08', '2023-05-14', 'ditolak upb', NULL, 'belum diterima', 'barang masih bagus', NULL),
(77, 30, 2, '150000', '1', 'Buah', '150000', 1, 'bak', '1', '2023-04-08', '2023-05-14', 'ditolak upb', NULL, 'belum diterima', 'xyz', NULL),
(82, 9, 1, '4000', '2', 'Buah', '8000', 1, 'admin', '2', '2023-05-06', '2023-05-14', 'disetujui', NULL, 'diterima', NULL, NULL),
(84, 36, 2, '5000', '10', 'Buah', '50000', 1, 'bak', '10', '2023-05-14', '2023-05-14', 'ditolak upb', NULL, 'belum diterima', 'barang masih ada', NULL),
(88, 21, 2, '20000', '1', 'Buah', '20000', 1, 'bak', '1', '2023-05-14', '2023-05-14', 'Telah Diterima', NULL, 'diterima', NULL, 'AC dingin'),
(89, 35, 1, '5000', '2', 'Buah', '10000', 1, 'admin', '2', '2023-05-14', NULL, 'waiting approvel', NULL, 'belum diterima', NULL, 'Kayu Jati'),
(90, 36, 2, '1000', '3', 'Buah', '3000', 1, 'bak', NULL, '2023-05-14', NULL, 'diusulkan', NULL, 'belum diterima', NULL, 'kayu jati'),
(91, 35, 2, '1300', '3', 'Buah', '3900', 1, 'bak', NULL, '2023-05-14', NULL, 'diusulkan', NULL, 'belum diterima', NULL, 'kayu mahoni'),
(93, 21, 13, '2000', '2', 'Buah', '4000', 1, 'Kemahasiswaan', NULL, '2023-05-14', NULL, 'diusulkan', NULL, 'belum diterima', NULL, 'ac sejuk');
...
INSERT INTO `suratkeluar` (`id_suratkeluar`, `tanggal`, `tujuan_pengiriman`, `no_surat`, `perihal`, `isi`, `file`) VALUES
(0, '2023-05-15', 'BAK', '001/BA/AMIKOMPWT/II/2023', 'Berita Acara Pengadaan Barang', 'berita acara pengadaan barang divisi bak', 'Smart-sistem_rt_051.pdf');
...
INSERT INTO `suratmasuk` (`id_suratmasuk`, `tanggal`, `perihal`, `isi`, `no_surat`, `pengirim`, `file`) VALUES
(4, '2023-05-14', 'surat pengadaan barang bagian aset dan kerumahtanggaan', 'surat pengadaan barang pada bulan mei', '001/PO/AMIKOMPWT/V/2023', 'BAK', 'Smart-sistem_rt_051.pdf');
...
INSERT INTO `tbl_bangunan` (`id_bangunan`, `id_lahan`, `kode_barang`, `tanggal_pembukuan`, `kode_bangunan`, `nama_bangunan`, `luas_bangunan`, `id_asal_barang`, `bulan_perolehan`, `tahun_perolehan`, `tanggal_perolehan`, `harga_perolehan`, `kapasitas_internet`, `keterangan`, `foto_bangunan`) VALUES
(3, 5, NULL, '2023-05-06', '2', 'Gedung Baru', '56', 6, NULL, '4000', '2023-05-06', '500', 'dgsdgs', 'erererere', 'wallpaperflare_com_wallpaper_(4).jpg'),
(10, 6, '2.04.07/09.2022', '', '1', 'Gedung Utama', '', 6, '09', '2022', '', '', '', '', ''),
(11, 9, '1.01.06/09.2011', '', '3', 'ceking', '60', 5, '09', '2011', '', '', '', '', '332474162_586500210036252_6080236724752854562_n.jpg');
...
(7, 21, 1, '1.001', '1.01.06/09.2022', 'Drum', 3, 'Baik', '567475', '54645', 7, '09', '2022', '2023-05-12', '40000', 'Baik', 'BAK', 'xixixiixix', 2, '661596_7202.jpg'),
...
INSERT INTO `tbl_lahan` (`id_lahan`, `kode_lahan`, `kode_barang`, `tanggal_pembukuan`, `nama_lahan`, `alamat`, `luas_lahan`, `id_asal_barang`, `bulan_perolehan`, `tahun_perolehan`, `tanggal_perolehan`, `harga_perolehan`, `harga_taksiran`, `nomor_sertifikat`, `status_sertifikat`, `status_tanah`, `sertifikat_yayasan`, `tanggal_sewa_mulai`, `tanggal_sewa_akhir`, `keterangan`, `foto_lahan`) VALUES
(5, '8', NULL, '2023-05-06', '23qwdawd', 'dfsdfs', '4444', 6, NULL, '4000', '2023-05-05', '4000', '4564', '45353', 'SHM', 'HM', 'TIDAK', '2023-05-05', '2023-05-06', 'nyicil', 'wallpaperflare_com_wallpaper_(4).jpg'),
(6, '1', NULL, '', 'Taplak', '', '70', 0, NULL, '', '', '', '', '', '', '', '', '', '', '', ''),
(7, '9', NULL, '', 'Taplak', '', '', 0, NULL, '', '', '', '', '', '', '', '', '', '', '', ''),
(8, '4', '1.01.06/08.2022', '2023-05-09', 'Tanah', 'fffff', '49', 4, '08', '2022', '2023-05-13', '4000', '56546', '56464', 'SHM', 'HM', 'YA', '2023-05-13', '2023-05-13', 'Golongan Tanah', 'rumput_1.jpg'),
(9, '2', '1.01.06/08.2009', '2023-05-13', 'Tanah Hak Milik', 'Purwokerto', '50', 6, '08', '2009', '2023-05-13', '4000', '145', '453453', 'SHM', 'HM', 'YA', '2023-05-11', '2023-05-13', 'ggreger', 'Jabat_tangan.jpg');
...
INSERT INTO `user` (`id`, `divisi`, `nama`, `email`, `contact`, `username`, `password`, `foto_ttd`, `role`, `active`) VALUES
(1, 'admin', 'Rizki Andika', 'rizkiandika79@gmail.com', '546546', 'admin', '21232f297a57a5a743894a0e4a801fc3', 'jabat_tangan.jpg', 1, 'Y'),
(2, 'bak', 'Muhtori', 'ckingg9@gmail.com', '090490594', 'ceking', '21232f297a57a5a743894a0e4a801fc3', 'jabat_tangan1.jpg', 2, 'Y'),
(10, 'upb', 'sohi gantenggg bangettttt', 'nvtzusy@gmail.com', '45645', 'shohi', '21232f297a57a5a743894a0e4a801fc3', 'centang.png', 3, 'Y'),
(13, 'Kemahasiswaan', 'mahasiswa', 'kemahasiswaan@gmail.com', '4563634', 'torey', '21232f297a57a5a743894a0e4a801fc3', 'Jabat_tangan4.jpg', 2, 'Y');
...
--
ALTER TABLE `tbl_bangunan`
  MODIFY `id_bangunan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
