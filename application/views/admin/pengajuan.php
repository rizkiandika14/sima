    ...
    <div class="container-fluid">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                ...
                <div class="body">
                    <form method="post" action="<?= base_url('admin/add_temp'); ?>">
                ...
                <div class="card">
                    ...
                    <div class="body">
                        <div class="table-responsive">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a class="btn btn-sm btn-danger tombol-hapus"
                                                href="<?= base_url() ?>admin/fungsi_delete_temp/<?= $tmp['id_tmp']; ?>"><span
                            ...
                            <form method="post" action="<?= base_url('admin/fungsi_pengajuan') ?>">
