        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                ...
                <div class="body">
                    ...
                    <?php echo form_open_multipart('admin/fungsi_edit_lahan'); ?>
                    <input type="hidden" id="id_lahan" name="id_lahan" class="form-control"
                        value="<?= $lahans['id_lahan']; ?>">
                    <label for="kode_lahan">Kode Lahan</label>
                    <div class="form-group">
                        <div class="form-line">
                            <input type="number" id="kode_lahan" name="kode_lahan" class="form-control"
                                value="<?= $lahans['kode_lahan']; ?>">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="form-line">
                            <input type="date" id="tanggal_pembukuan" name="tanggal_pembukuan" class="form-control"
                                value="<?= $lahans['tanggal_pembukuan']; ?>">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="form-line">
                            <input type="text" data-toggle="modal" data-target="#defaultModal" name="asal_barang"
                                ...
                                value="<?= $lahans['nama_asal_barang']; ?>" autocomplete="off">
                            <input type="hidden" id="id_asal_barang" name="id_asal_barang"
                                value="<?= $lahans['id_asal_barang']; ?>">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="form-line">
                            <input type="date" id="tanggal_perolehan" name="tanggal_perolehan" class="form-control"
                                value="<?= $lahans['tanggal_perolehan']; ?>">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="form-line">
                            <select name="status_sertifikat" id="status_sertifikat" class="form-control">
                                <option><?= $lahans['status_sertifikat']; ?></option>
                                <option value="SHM">
                                    SHM
                                </option>
                                <option value="HGB">
                    ...
                    <div class="form-group">
                        <div class="form-line">
                            <select name="status_tanah" id="status_tanah" class="form-control">
                                <option> <?= $lahans['status_tanah']; ?></option>
                                <option value="HM">
                                    HM
                                </option>
                                <option value="SEWA">
                    ...
                    <label for="sertifikat_yayasan">Sertifikat a.n. Yayasan (diisi apabila status tanah : HM)</label>
                    <div class="form-group">
                        <div class="form-line">
                            <select name="sertifikat_yayasan" id="sertifikat_yayasan" class="form-control">
                                <option><?= $lahans['sertifikat_yayasan']; ?></option>
                                <option value="YA">
                                    YA
                                </option>
                                <option value="TIDAK">
                    ...
                    <div class="form-group">
                        <div class="form-line">
                            <input type="date" id="tanggal_sewa_mulai" name="tanggal_sewa_mulai" class="form-control"
                                value="<?= $lahans['tanggal_sewa_mulai']; ?>">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="form-line">
                            <input type="date" id="tanggal_sewa_akhir" name="tanggal_sewa_akhir" class="form-control"
                                value="<?= $lahans['tanggal_sewa_akhir']; ?>">
                        </div>
                    </div>
