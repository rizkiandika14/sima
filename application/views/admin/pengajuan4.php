    ...
    <div class="container-fluid">
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
            <div class="card">
                ...
                <div class="body">
                    <form method="post" action="<?= base_url('admin/add_temp4'); ?>">
                ...
                <div class="card">
                    ...
                    <div class="body">
                        <div class="table-responsive">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a class="btn btn-sm btn-danger tombol-hapus"
                                                href="<?= base_url() ?>admin/fungsi_delete_temp4/<?= $tmp['id_tmp']; ?>"><span
                            ...
                            <form method="post" action="<?= base_url('admin/fungsi_pengajuan4') ?>">
