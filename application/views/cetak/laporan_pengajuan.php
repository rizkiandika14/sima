        ...
        <table class="tabel2">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="text-align: center; font-size: 12px;"><?= $dp['satuan']; ?></td>
            ...
            <tfoot>
                ...
                $totalp = $this->db->query("SELECT sum(total) as totalp FROM pengajuan Where minggu = $minggu AND waktu_pengajuan = '$tanggal' AND divisi = '$divisi' AND status = 'proses'");
