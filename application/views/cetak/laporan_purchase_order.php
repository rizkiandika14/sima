...
<body>
    ...
    <hr>
    <p align="center" style="font-weight: bold; font-size: 18px;">PURCHASE ORDER</p>
    ...
    <table class="table table-no-bordered">
        ...
        <tr>
            <td align="justify">
                ...
                Jl. Let.Jend.Pol. Soemarto (depan SPN), Watumas, Purwanagara, Purwokerto Utara
                Phone: 0281-623321
                HP/WA: (+62) 0857-1410-6913
    ...
    <div class="isi" style="margin: 0 auto;">
        ...
        <p style="color: black; text-align: left;"> No : 0001/PO/UPB/AMIKOMPWT/II/2023 <br>
        ...
        <table class="tabel2">
            ...
            <tfoot>
                ...
                $totalp = $this->db->query("SELECT sum(total) as totalp FROM pengajuan Where minggu = $minggu AND waktu_pengajuan = '$tanggal' AND divisi = '$divisi' AND status = 'disetujui upb'");
