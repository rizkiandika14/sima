    ...
    <div class="container-fluid">
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
            <div class="card">
                <div class="header">
                    <h2>
                        Pengajuan Minggu ke 4 </h2>
                </div>
                <div class="body">
                    <form method="post" action="<?= base_url('divisi/add_temp4'); ?>">
                        ...
                        <input type="hidden" name="minggu" id="minggu" value="4">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped table-hover dataTable js-basic-example"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a class="btn btn-sm btn-danger tombol-hapus"
                                                href="<?= base_url() ?>divisi/fungsi_delete_temp4/<?= $tmp['id_tmp']; ?>"><span
                                ...
                                <tfoot>
                                    ...
                                    $totalp = $this->db->query("SELECT sum(total) as totalp FROM barang_temp Where user_id = $user_id AND minggu = 4");
                            ...
                            <form method="post" action="<?= base_url('divisi/fungsi_pengajuan4') ?>">
