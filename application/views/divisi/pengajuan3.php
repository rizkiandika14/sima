    ...
    <div class="container-fluid">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                ...
                <div class="body">
                    <form method="post" action="<?= base_url('divisi/add_temp3'); ?>">
                ...
                <div class="card">
                    ...
                    <div class="body">
                        <div class="table-responsive">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a class="btn btn-sm btn-danger tombol-hapus"
                                                href="<?= base_url() ?>divisi/fungsi_delete_temp3/<?= $tmp['id_tmp']; ?>"><span
                            ...
                            <form method="post" action="<?= base_url('divisi/fungsi_pengajuan3') ?>">
