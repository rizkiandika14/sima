    ...
    <div class="container-fluid">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                <div class="header">
                    <h2>
                        Pengajuan Minggu ke 1 </h2>
                </div>
                <div class="body">
                    <form method="post" action="<?= base_url('divisi/add_temp'); ?>">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped table-hover dataTable js-basic-example"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a class="btn btn-sm btn-danger tombol-hapus"
                                                href="<?= base_url() ?>divisi/fungsi_delete_temp/<?= $tmp['id_tmp']; ?>"><span
                                ...
                                <tfoot>
                                    ...
                                    $totalp = $this->db->query("SELECT sum(total) as totalp FROM barang_temp Where user_id = $user_id AND minggu = 1");
                            ...
                            <form method="post" action="<?= base_url('divisi/fungsi_pengajuan') ?>">
