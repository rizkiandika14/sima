            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header">
                        ...
                        <form
                            action="<?= base_url('export/cetak_pengajuan_upb'); ?>/<?= $tanggal ?>/<?= $divisi ?>/<?= $minggu ?>"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <!-- <a class="btn btn-sm btn-info"
                                                href="<?= base_url() ?>Upb/diproses/<?= $dp['id']; ?>"><span
                                            ...
                                            <div class="btn btn-sm btn-info">
                                                <div class="demo-google-material-icon" data-toggle="modal"
                                                    data-target="#editprModal<?= $dp['id']; ?>"> <i
                                                        class="material-icons"></i> <span
                                                        class="icon-name">Proses</span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="btn btn-sm btn-danger">
                                                <div class="demo-google-material-icon" data-toggle="modal"
                                                    data-target="#tolakModal<?= $dp['id']; ?>"> <i
                                            ...
                                            <!-- <a class="btn btn-sm btn-danger"
                                                href="<?= base_url() ?>Upb/ditolak/<?= $dp['id']; ?>"><span
                                                    class="fa fa-trash"></span>
                                                Tolak</a> -->
...
$no = 0;
foreach ($dpengajuan as $brg) : $no++; ?>
<div class="modal fade" id="editprModal<?= $brg['id']; ?>" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="defaultModalLabel">SETUJUI PENGAJUAN</h4>
            ...
            <div class="modal-body">
                <?= form_open_multipart('upb/proses') ?>
                <input type="hidden" name="id" value="<?= $brg['id']; ?>">
                <div class="body">
                    <form class="form-horizontal">
                        <div class="row clearfix">
