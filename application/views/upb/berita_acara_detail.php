<section class="content">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header">
                        ...
                        <form
                            action="<?= base_url('export/cetak_berita_acara'); ?>/<?= $tanggal ?>/<?= $divisi ?>/<?= $minggu ?>"
                            ...
                            <table class="table table-bordered table-striped table-hover dataTable js-basic-example"
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?= $dba['realisasi']; ?></td>
                                        <td><?= $dba['satuan']; ?></td>
                                        <td>Rp. <?= number_format($dba['harga']);  ?></td>
                                        <td>Rp. <?= number_format($dba['total']); ?></td>
                                        <!-- <td><?= $dba['status']; ?></td> -->
    ...
    <?php
    $no = 0;
    foreach ($dberita_acara as $brg) : $no++; ?>
